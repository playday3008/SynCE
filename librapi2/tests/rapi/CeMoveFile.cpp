...
int main()
{
	...
	rapi_wstr_append(filename1, to_unicode("\\librapi test file 1.txt"), sizeof(filename1));
	rapi_wstr_append(filename2, to_unicode("\\librapi test file 2.txt"), sizeof(filename2));

...
<h1>SynCE - KDE PDAMirror<br>
</h1>
<h2>Introduction</h2>
SynCE-KDE PDAMirror is a system to interact with a Windows CE device by
...
Both components, screensnap and PDAMirror gets installed during the
...
start up PDAMirror checks the Windows CE device for an already
installed screensnap. If it doesn't find screensnap on the device
PDAMirror installs this component automatically on the device.<br>
Regardless PDAMirror has to install screensnap first or not, it will
start up
screensnap on the Windows CE device before initiating a
network connection to it. On success, PDAMirror presents a window on
the display of the PC showing the screen of the Windows CE device. <br>
As long as the PDAMirror window owns the input focus, all mouse and
...
<table align="center" width="100%" border="0" cellspacing="2"
 ...
 alt="pdamirror-menu" title="Open Menu" src="images/pdamirror-menu.png"><br>
      </td>
      <td align="center" valign="top"><img height="403" width="247"
 alt="pdamirror-note" title="Written Note"
